...
class RequiredMerchantTransactionIdStatusResponsePaymentsItem(TypedDict):
    id: UniqueId
...
class OptionalMerchantTransactionIdStatusResponsePaymentsItem(TypedDict, total=False):
    card: ResponseCard
...
class MerchantTransactionIdStatusResponsePaymentsItem(RequiredMerchantTransactionIdStatusResponsePaymentsItem, OptionalMerchantTransactionIdStatusResponsePaymentsItem):
    pass
