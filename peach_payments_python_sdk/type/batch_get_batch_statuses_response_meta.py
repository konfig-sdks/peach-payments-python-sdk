...
class RequiredBatchGetBatchStatusesResponseMeta(TypedDict):
    pass

class OptionalBatchGetBatchStatusesResponseMeta(TypedDict, total=False):
...
class BatchGetBatchStatusesResponseMeta(RequiredBatchGetBatchStatusesResponseMeta, OptionalBatchGetBatchStatusesResponseMeta):
    pass
