...
class BaseApi(api_client.Api):
    ...
    def _initiate_payment_mapped_args(
        self,
        referer: str,
    ...
    async def _ainitiate_payment_oapg(
        self,
...
class InitiatePaymentRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ainitiate_payment(
        self,
        referer: str,
        authentication_entity_id: str,
        signature: str,
        ...
        **kwargs,
        ...
        args = self._initiate_payment_mapped_args(
            referer=referer,
        ...
        return await self._ainitiate_payment_oapg(
            body=args.body,
    ...
    def initiate_payment(
        ...
        return self._initiate_payment_oapg(
            body=args.body,
            header_params=args.header,
        )

class InitiatePayment(BaseApi):
    ...
    async def ainitiate_payment(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.ainitiate_payment(
            referer=referer,
            authentication_entity_id=authentication_entity_id,
            signature=signature,
            merchant_transaction_id=merchant_transaction_id,
    ...
    def initiate_payment(
        ...
        raw_response = self.raw.initiate_payment(
            referer=referer,
            authentication_entity_id=authentication_entity_id,
            signature=signature,
            merchant_transaction_id=merchant_transaction_id,
