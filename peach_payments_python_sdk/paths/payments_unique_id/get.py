...
from peach_payments_python_sdk.model.transaction_id_status_response import TransactionIdStatusResponse as TransactionIdStatusResponseSchema
...
from peach_payments_python_sdk.type.transaction_id_status_response import TransactionIdStatusResponse
...
from peach_payments_python_sdk.pydantic.transaction_id_status_response import TransactionIdStatusResponse as TransactionIdStatusResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = TransactionIdStatusResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: TransactionIdStatusResponse
...
class BaseApi(api_client.Api):
    ...
    def _query_transaction_by_id_mapped_args(
        self,
        unique_id: UniqueId,
    ...
    async def _aquery_transaction_by_id_oapg(
        self,
    ...
    def _query_transaction_by_id_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class QueryTransactionByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aquery_transaction_by_id(
        self,
        unique_id: UniqueId,
        authentication_entity_id: EntityId,
        authentication_user_id: UserId,
        ...
        **kwargs,
        ...
        args = self._query_transaction_by_id_mapped_args(
            unique_id=unique_id,
            authentication_entity_id=authentication_entity_id,
            authentication_user_id=authentication_user_id,
            authentication_password=authentication_password,
        )
        return await self._aquery_transaction_by_id_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def query_transaction_by_id(
        self,
        unique_id: UniqueId,
        authentication_entity_id: EntityId,
        authentication_user_id: UserId,
        ...
        return self._query_transaction_by_id_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class QueryTransactionById(BaseApi):
    ...
    async def aquery_transaction_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TransactionIdStatusResponsePydantic:
        raw_response = await self.raw.aquery_transaction_by_id(
            unique_id=unique_id,
            authentication_entity_id=authentication_entity_id,
            authentication_user_id=authentication_user_id,
            authentication_password=authentication_password,
        ...
        if validate:
            return TransactionIdStatusResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(TransactionIdStatusResponsePydantic, raw_response.body)
    ...
    def query_transaction_by_id(
        ...
        raw_response = self.raw.query_transaction_by_id(
            unique_id=unique_id,
            authentication_entity_id=authentication_entity_id,
            authentication_user_id=authentication_user_id,
            authentication_password=authentication_password,
