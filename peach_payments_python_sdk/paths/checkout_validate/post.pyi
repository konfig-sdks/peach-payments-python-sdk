...
from peach_payments_python_sdk.model.checkout_generation_validate_request_response import CheckoutGenerationValidateRequestResponse as CheckoutGenerationValidateRequestResponseSchema

from peach_payments_python_sdk.type.message_response import MessageResponse
from peach_payments_python_sdk.type.checkout_generation_validate_request_response import CheckoutGenerationValidateRequestResponse
...
from peach_payments_python_sdk.pydantic.checkout_generation_validate_request_response import CheckoutGenerationValidateRequestResponse as CheckoutGenerationValidateRequestResponsePydantic
...
SchemaFor400ResponseBodyApplicationJson = CheckoutGenerationValidateRequestResponseSchema


@dataclass
class ApiResponseFor400(api_client.ApiResponse):
    body: CheckoutGenerationValidateRequestResponse
...
class BaseApi(api_client.Api):
    ...
    def _validate_request_mapped_args(
        self,
    ...
    async def _avalidate_request_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/checkout/validate',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
...
class ValidateRequestRaw(BaseApi):
    ...
    async def avalidate_request(
        ...
        **kwargs,
        ...
        args = self._validate_request_mapped_args(
        ...
        return await self._avalidate_request_oapg(
            body=args.body,
    ...
    def validate_request(
        ...
        return self._validate_request_oapg(
            body=args.body,
            header_params=args.header,
        )

class ValidateRequest(BaseApi):
    ...
    async def avalidate_request(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.avalidate_request(
            authentication_entity_id=authentication_entity_id,
            signature=signature,
            merchant_transaction_id=merchant_transaction_id,
            amount=amount,
        ...
        if validate:
            return MessageResponsePydantic(**raw_response.body)
    ...
    def validate_request(
        ...
        raw_response = self.raw.validate_request(
            authentication_entity_id=authentication_entity_id,
            signature=signature,
            merchant_transaction_id=merchant_transaction_id,
            amount=amount,
