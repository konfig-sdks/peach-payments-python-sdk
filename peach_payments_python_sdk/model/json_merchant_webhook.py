...
class JSONMerchantWebhook(
    ...
    encryptedBody: schemas.AnyTypeSchema
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["encryptedData", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["encryptedData", ], str]):
