...
class CheckoutV2Billing(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["street1", "street2", "city", "company", "country", "state", "postcode", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["street1", "street2", "city", "company", "country", "state", "postcode", ], str]):
