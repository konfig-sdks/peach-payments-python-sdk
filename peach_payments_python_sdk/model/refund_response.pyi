...
class RefundResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "amount", "currency", "paymentType", "result", "timestamp", "paymentBrand", "resultDetails", "connectorTxID1", "customParameters", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "amount", "currency", "paymentType", "result", "timestamp", "paymentBrand", "resultDetails", "connectorTxID1", "customParameters", ], str]):
