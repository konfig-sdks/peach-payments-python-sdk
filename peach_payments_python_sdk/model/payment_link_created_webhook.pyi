...
class PaymentLinkCreatedWebhook(
    ...
    class MetaOapg:
        ...
        class all_of_1(
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["status", "url", ], str]):
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["status", "url", ], str]):
