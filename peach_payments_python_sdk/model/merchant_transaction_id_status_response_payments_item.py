...
class MerchantTransactionIdStatusResponsePaymentsItem(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "paymentType", "paymentBrand", "amount", "currency", "merchantTransactionId", "result", "resultDetails", "connectorTxID1", "timestamp", "customParameters", "card", "merchantInvoiceId", "recon", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "paymentType", "paymentBrand", "amount", "currency", "merchantTransactionId", "result", "resultDetails", "connectorTxID1", "timestamp", "customParameters", "card", "merchantInvoiceId", "recon", ], str]):
    ...
    ) -> 'MerchantTransactionIdStatusResponsePaymentsItem':
