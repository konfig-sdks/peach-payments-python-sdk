...
class PaymentOptions(BaseModel):
    ...
    email_cc: typing.Optional[str] = Field(None, alias='emailCc')

    # List of comma-separated email addresses to BCC.
    email_bcc: typing.Optional[str] = Field(None, alias='emailBcc')

    # Time in minutes until the link expires. By default, expiry time is set to 30 days, which is also the maximum expiry time.
    expiry_time: typing.Optional[int] = Field(None, alias='expiryTime')
